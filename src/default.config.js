...
export const config = {
  ...
  GITHUB_API_KEY: '95c341581a0f856f4c6c2b8124c6b18fb58cf21c',
  GITHUB_AUTH_ID: '94e80bb42b355c95b9a8',
  GITHUB_AUTH_SECRET: 'f311e4adb1b3fc023ba34a08c897c166c6e3bd37',
  ssl: {
    keyPath: '/etc/letsencrypt/live/api.randia.eu/privkey.pem',
    certPath: '/etc/letsencrypt/live/api.randia.eu/fullchain.pem'
  }
};
